...
export class LanguageService {
  ...
  private readonly dictionary: Record<LanguageType, Record<string, string>> = {
    en: {
      ...
      // Custom Widgets
      'WIDGET_LATTICE_TITLE': 'Lattice-Based Key Generator',
      'WIDGET_LATTICE_DESC': 'Generate post-quantum secure cryptographic keys in your sandbox environment.',
      'WIDGET_LATTICE_BTN': 'Generate Key Pair',
      'WIDGET_LATTICE_BTN_RUNNING': 'Running Lattice Solver...',
      'WIDGET_LATTICE_PUB': 'Lattice Public Key (NTRU-Safe)',
      'WIDGET_LATTICE_PRIV': 'Lattice Private Key (NTRU-Safe)',
      'WIDGET_LATTICE_COMPUTING': 'Computing high-dimensional polynomial...',
      'WIDGET_LATTICE_EXTRACTING': 'Extracting shortest-vector coefficient...',
      'WIDGET_API_TITLE': 'JSON-RPC Sandbox Executor',
      'WIDGET_API_DESC': 'Test real-time Neuralis network endpoints and view parsed response payloads.',
      'WIDGET_API_SELECT': 'Select Endpoint',
      'WIDGET_API_BTN': 'Send API Call',
      'WIDGET_API_PAYLOAD': 'Response Payload',
      'WIDGET_API_STATUS': 'STATUS',
      'WIDGET_API_EMPTY': 'Select an endpoint and click "Send API Call" to preview output...',
      'WIDGET_API_RUNNING': 'Requesting secure gate socket...',
      'WIDGET_STRESS_TITLE': 'Hardware Performance Stress Simulator',
      'WIDGET_STRESS_DESC': 'Test the physical boundaries of custom ASIC boards under varying cognitive thread loads.',
      'WIDGET_STRESS_BTN': 'Execute Stress Test',
      'WIDGET_STRESS_BTN_RUNNING': 'Test Running...',
      'WIDGET_STRESS_TEMP': 'Asic Core Temp',
      'WIDGET_STRESS_IOPS': 'Calculated IOPS',
      'WIDGET_VAL_TITLE': 'Decentralized Delegation Hub',
      'WIDGET_VAL_DESC': 'Delegate your $NEURAL stakes to active consensus validators to secure the mesh.',
      'WIDGET_VAL_SELECT': 'Select Validator',
      'WIDGET_VAL_AMOUNT': 'Staking Amount',
      'WIDGET_VAL_BTN': 'Delegate Now',
      'WIDGET_VAL_BTN_RUNNING': 'Broadcasting Delegation...',
      'WIDGET_VAL_ROSTER': 'Validator Roster & Stakes',
      'WIDGET_VAL_COMMISSION': 'Commission',
      'WIDGET_VAL_TOTAL_STAKE': 'Total Stake',
      'WIDGET_VAL_DELEGATED': 'Delegated',
      'WIDGET_GOV_TITLE': 'Decentralized Governance Board',
      'WIDGET_GOV_DESC': 'Submit and cast cryptographic votes on active core protocols improvement proposals.',
      'WIDGET_GOV_VOTE_FOR': 'Vote For',
      'WIDGET_GOV_VOTE_AGAINST': 'Vote Against',
      'WIDGET_GOV_VOTED': 'Vote registered',
      'WIDGET_INT_TITLE': 'Multi-Chain Web3 SDK Integration',
      'WIDGET_INT_DESC': 'Synchronize validation channels into Ethereum EVM, Solana, or Cosmos structures.',
      'WIDGET_INT_CODE': 'Integration code (NodeJS / JS)',
      'WIDGET_INT_COPY': 'Copy Code',
      'WIDGET_CLI_TITLE': 'CLI Command Glossary',
      'WIDGET_CLI_DESC': 'Copy terminal commands and parameters directly for deployment.',
      'WIDGET_CLI_COPY': 'Copy',
      'WIDGET_TUT_TITLE': 'Developer Tutorials & Progress Tracker',
      'WIDGET_TUT_DESC': 'Check off completed guides to track your system integration credentials.',
      'WIDGET_TUT_CREDENTIALS': 'Overall Credentials Progress',
      'WIDGET_TUT_UNLOCKED': 'Complete tutorials to unlock validator certificates and bonus $NEURAL yields.',
      'WIDGET_COMPLIANCE_TITLE': 'Regulatory Compliance Audit Checker',
      'WIDGET_COMPLIANCE_DESC': 'Self-audit validator nodes to ensure zero regulatory compliance slashes.',
      'WIDGET_PRIVACY_TITLE': 'Browser Configuration Cache Manager',
      'WIDGET_PRIVACY_DESC': 'We store only your theme preference and active language choice inside your local browser. Clear them at any time.',
      'WIDGET_PRIVACY_CACHE': 'Active Cached Configuration Data:',
      'WIDGET_PRIVACY_CLEAR': 'Clear Configuration Cache',
      'WIDGET_SEC_TITLE': 'Vulnerability Reward Sandbox Calculator',
      'WIDGET_SEC_DESC': 'Select severity level of a bug disclosure to estimate the bounty rewards payout.',
      'WIDGET_SEC_SEVERITY': 'Severity Level',
      'WIDGET_SEC_BOUNTY': 'Estimated Bounty Staking Reward',
      'WIDGET_SEC_SUBMIT': 'Submit disclosure logs directly to security@hejidraft.com. High severity requires a full cryptographic proof-of-concept.',
      'WIDGET_TERMS_TITLE': 'Service Acceptance Socket',
      'WIDGET_TERMS_DESC': 'Casting wallet links binds your browser identity to standard mesh validator rules.',
      'WIDGET_TERMS_CHECK': 'I acknowledge and accept terms and validator configurations.',
      'WIDGET_GETTING_TITLE': 'Interactive CLI Install Wizard',
      'WIDGET_GETTING_DESC': 'Initialize your terminal client, sync profiles, and launch your first local validator node.',
      'WIDGET_GETTING_CHECKLIST': 'Installation Checklist',
      'WIDGET_GETTING_STANDARD': 'Standard Installation Command',
      'WIDGET_ARCH_TITLE': 'System Architecture Blueprints',
      'WIDGET_ARCH_DESC': 'Hover over the layers to inspect integration scopes, APIs, and validation protocols.',
      'WIDGET_ARCH_SPECS': 'Layer Specs',
      'NAV_UI_KIT': 'Obsidian Flux UI Kit',
      'NAV_UI_DOCS': 'Base UI Docs',
      'UI_KIT_TITLE': 'Obsidian Flux UI Kit',
      'UI_KIT_SUBTITLE': 'A premium library of high-performance glassmorphic and holographic components designed for Web3. Tweak the styles in real-time and copy the production-ready code.',
      'UI_KIT_THEME_TITLE': 'Global Style Customizer',
      'UI_KIT_PRIMARY_COLOR': 'Primary Accent Color',
      'UI_KIT_PRIMARY_HUE': 'Primary Hue',
      'UI_KIT_PRIMARY_SAT': 'Primary Saturation',
      'UI_KIT_PRIMARY_LIGHT': 'Primary Lightness',
      'UI_KIT_GLASS_OPACITY': 'Glass Opacity',
      'UI_KIT_GLASS_BLUR': 'Backdrop Blur',
      'UI_KIT_BORDER_STYLE': 'Border Weight',
      'UI_KIT_BORDER_NONE': 'None',
      'UI_KIT_BORDER_THIN': 'Thin',
      'UI_KIT_BORDER_THICK': 'Thick',
      'UI_KIT_CATEGORIES': 'Component Categories',
      'UI_KIT_CAT_ALL': 'All Components',
      'UI_KIT_CAT_BUTTONS': 'Buttons & Actions',
      'UI_KIT_CAT_CARDS': 'Frosted Plates',
      'UI_KIT_CAT_INPUTS': 'Console Inputs',
      'UI_KIT_CAT_INDICATORS': 'System Indicators',
      'UI_KIT_WORKBENCH_TITLE': 'Interactive Sandbox Workbench',
      'WIDGET_UI_KIT_DESC': 'Test your customized UI elements in real-time, arrange layouts, and export the finished codebase styling values.',
      'UI_KIT_COPY_SUCCESS': 'Markup copied successfully!',
      'UI_KIT_TAILWIND_CONFIG_TITLE': 'Tailwind Configuration Extension',
      'UI_KIT_VARIANT': 'Variant:'
    },
    vi: {
      // General Navigation & Switcher
      ...
      // Custom Widgets
      'WIDGET_LATTICE_TITLE': 'Trình tạo khóa mã hóa Lattice',
      'WIDGET_LATTICE_DESC': 'Tạo cặp khóa mã hóa an toàn kháng lượng tử trong môi trường thử nghiệm.',
      'WIDGET_LATTICE_BTN': 'Tạo Cặp Khóa',
      'WIDGET_LATTICE_BTN_RUNNING': 'Đang tính toán giải mã Lattice...',
      'WIDGET_LATTICE_PUB': 'Khóa công khai Lattice (NTRU-Safe)',
      'WIDGET_LATTICE_PRIV': 'Khóa bí mật Lattice (NTRU-Safe)',
      'WIDGET_LATTICE_COMPUTING': 'Đang tính toán đa thức cao chiều...',
      'WIDGET_LATTICE_EXTRACTING': 'Đang giải ma trận hệ số vector ngắn nhất...',
      'WIDGET_API_TITLE': 'Trình chạy thử Sandbox API',
      'WIDGET_API_DESC': 'Thử nghiệm các điểm cuối mạng thời gian thực và xem dữ liệu JSON phản hồi.',
      'WIDGET_API_SELECT': 'Chọn Điểm Cuối',
      'WIDGET_API_BTN': 'Gửi Yêu Cầu API',
      'WIDGET_API_PAYLOAD': 'Dữ Liệu Phản Hồi JSON',
      'WIDGET_API_STATUS': 'TRẠNG THÁI',
      'WIDGET_API_EMPTY': 'Hãy chọn một điểm cuối và bấm nút gửi để xem kết quả phản hồi...',
      'WIDGET_API_RUNNING': 'Đang kết nối cổng socket bảo mật...',
      'WIDGET_STRESS_TITLE': 'Trình Giả Lập Stress-Test Phần Cứng',
      'WIDGET_STRESS_DESC': 'Kiểm tra độ chịu tải tối đa của vi xử lý ASIC dưới các mức luồng xử lý nhận thức khác nhau.',
      'WIDGET_STRESS_BTN': 'Bắt Đầu Chạy Stress Test',
      'WIDGET_STRESS_BTN_RUNNING': 'Đang chạy tải stress...',
      'WIDGET_STRESS_TEMP': 'Nhiệt Độ Lõi ASIC',
      'WIDGET_STRESS_IOPS': 'Hiệu Suất IOPS Đạt Được',
      'WIDGET_VAL_TITLE': 'Trung Tâm Ủy Quyền Validator',
      'WIDGET_VAL_DESC': 'Ủy thác số dư $NEURAL của bạn cho các validator trạm để chia sẻ lợi nhuận bảo mật mạng lưới.',
      'WIDGET_VAL_SELECT': 'Lựa Chọn Validator',
      'WIDGET_VAL_AMOUNT': 'Số Lượng Ủy Thác Staking',
      'WIDGET_VAL_BTN': 'Tiến Hành Ủy Quyền',
      'WIDGET_VAL_BTN_RUNNING': 'Đang gửi giao dịch lên mạng lưới...',
      'WIDGET_VAL_ROSTER': 'Danh Sách Validator & Stakes',
      'WIDGET_VAL_COMMISSION': 'Phí Hoa Hồng',
      'WIDGET_VAL_TOTAL_STAKE': 'Tổng Cổ Phần Stake',
      'WIDGET_VAL_DELEGATED': 'Đã Ủy Quyền',
      'WIDGET_GOV_TITLE': 'Hội Đồng Quản Trị Phi Tập Trung',
      'WIDGET_GOV_DESC': 'Tham gia bỏ phiếu biểu quyết mã hóa cho các đề xuất nâng cấp cải tiến hệ thống cốt lõi.',
      'WIDGET_GOV_VOTE_FOR': 'Biểu Quyết Thuận',
      'WIDGET_GOV_VOTE_AGAINST': 'Biểu Quyết Chống',
      'WIDGET_GOV_VOTED': 'Đã ghi nhận biểu quyết thành công',
      'WIDGET_INT_TITLE': 'Tích Hợp Web3 SDK Đa Chuỗi',
      'WIDGET_INT_DESC': 'Đồng bộ hóa kênh dữ liệu của bạn vào các cấu trúc của Ethereum EVM, Solana hoặc Cosmos.',
      'WIDGET_INT_CODE': 'Mã Nguồn Tích Hợp (NodeJS / JS)',
      'WIDGET_INT_COPY': 'Sao Chép Mã',
      'WIDGET_CLI_TITLE': 'Mục Tra Cứu Lệnh CLI Thường Gặp',
      'WIDGET_CLI_DESC': 'Sao chép nhanh các dòng lệnh terminal điều hành để triển khai.',
      'WIDGET_CLI_COPY': 'Sao Chép',
      'WIDGET_TUT_TITLE': 'Các Bài Học & Theo Dõi Tiến Độ Lập Trình',
      'WIDGET_TUT_DESC': 'Đánh dấu các bài học đã hoàn tất để theo dõi tiến trình cấp chứng nhận tích hợp.',
      'WIDGET_TUT_CREDENTIALS': 'Tổng Tiến Độ Học Tập',
      'WIDGET_TUT_UNLOCKED': 'Hoàn thành các bài học để nhận chứng chỉ lập trình viên và tăng APY $NEURAL.',
      'WIDGET_COMPLIANCE_TITLE': 'Trình Tự Kiểm Tra Tuân Thủ Quy Định',
      'WIDGET_COMPLIANCE_DESC': 'Tự kiểm tra các cấu trúc trạm để đảm bảo không vi phạm quy chuẩn vận hành mạng lưới.',
      'WIDGET_PRIVACY_TITLE': 'Trình Quản Lý Bộ Nhớ Cục Bộ',
      'WIDGET_PRIVACY_DESC': 'Chúng tôi chỉ lưu trữ cấu hình giao diện và tùy chọn ngôn ngữ trong cache trình duyệt của bạn. Xóa bất cứ lúc nào.',
      'WIDGET_PRIVACY_CACHE': 'Thông Tin Đang Được Lưu Cục Bộ:',
      'WIDGET_PRIVACY_CLEAR': 'Xóa Bộ Nhớ Cục Bộ',
      'WIDGET_SEC_TITLE': 'Trình Ước Tính Phần Thưởng Lỗ Hổng',
      'WIDGET_SEC_DESC': 'Lựa chọn cấp độ nghiêm trọng của lỗi bảo mật phát hiện được để ước tính giá trị giải thưởng.',
      'WIDGET_SEC_SEVERITY': 'Cấp Độ Nghiêm Trọng',
      'WIDGET_SEC_BOUNTY': 'Phần Thưởng Bounty Ước Tính',
      'WIDGET_SEC_SUBMIT': 'Gửi báo cáo bảo mật trực tiếp đến địa chỉ security@hejidraft.com. Cấp độ lỗi cao yêu cầu mã PoC chi tiết.',
      'WIDGET_TERMS_TITLE': 'Xác Nhận Đồng Ý Dịch Vụ',
      'WIDGET_TERMS_DESC': 'Kết nối liên kết ví ràng buộc thiết bị trình duyệt của bạn tuân thủ các quy tắc trạm xác thực.',
      'WIDGET_TERMS_CHECK': 'Tôi xác nhận đã đọc và đồng ý với tất cả điều khoản dịch vụ.',
      'WIDGET_GETTING_TITLE': 'Hướng Dẫn Thiết Lập Cài Đặt CLI',
      'WIDGET_GETTING_DESC': 'Khởi tạo cấu hình terminal của bạn, đồng bộ hóa hồ sơ và chạy trạm xác thực cục bộ đầu tiên.',
      'WIDGET_GETTING_CHECKLIST': 'Các Bước Cần Chuẩn Bị',
      'WIDGET_GETTING_STANDARD': 'Dòng Lệnh Cài Đặt Tiêu Chuẩn',
      'WIDGET_ARCH_TITLE': 'Sơ Đồ Kiến Trúc Hệ Thống Chi Tiết',
      'WIDGET_ARCH_DESC': 'Di chuột qua các phân lớp sơ đồ để xem chi tiết các cổng tích hợp kết nối và giao thức đồng thuận.',
      'WIDGET_ARCH_SPECS': 'Thông Số Các Lớp',
      'NAV_UI_KIT': 'Thư viện UI Obsidian Flux',
      'NAV_UI_DOCS': 'Tài liệu Base UI',
      'UI_KIT_TITLE': 'Thư viện UI Obsidian Flux',
      'UI_KIT_SUBTITLE': 'Bộ sưu tập các thành phần phủ kính (glassmorphism) và hình chiếu hologram hiệu năng cao dành cho Web3. Tùy chỉnh trực tiếp phong cách và sao chép mã nguồn.',
      'UI_KIT_THEME_TITLE': 'Bộ Cấu Hình Phong Cách Toàn Cục',
      'UI_KIT_PRIMARY_COLOR': 'Màu Nhấn Chủ Đạo',
      'UI_KIT_PRIMARY_HUE': 'Tông Màu Chủ Đạo',
      'UI_KIT_PRIMARY_SAT': 'Độ Bão Hòa Chủ Đạo',
      'UI_KIT_PRIMARY_LIGHT': 'Độ Sáng Chủ Đạo',
      'UI_KIT_GLASS_OPACITY': 'Độ Mờ Của Kính',
      'UI_KIT_GLASS_BLUR': 'Độ Nhòe Nền',
      'UI_KIT_BORDER_STYLE': 'Độ Dày Viền',
      'UI_KIT_BORDER_NONE': 'Không viền',
      'UI_KIT_BORDER_THIN': 'Mỏng',
      'UI_KIT_BORDER_THICK': 'Dày',
      'UI_KIT_CATEGORIES': 'Danh Mục Thành Phần',
      'UI_KIT_CAT_ALL': 'Tất Cả Thành Phần',
      'UI_KIT_CAT_BUTTONS': 'Nút & Hành Động',
      'UI_KIT_CAT_CARDS': 'Thẻ Phủ Kính',
      'UI_KIT_CAT_INPUTS': 'Đầu Vào CLI',
      'UI_KIT_CAT_INDICATORS': 'Đèn Báo Trạng Thái',
      'UI_KIT_WORKBENCH_TITLE': 'Hộp Cát Thiết Kế Tương Tác',
      'WIDGET_UI_KIT_DESC': 'Kiểm tra các thành phần giao diện đã chỉnh sửa theo thời gian thực, sắp xếp bố cục và xuất các thông số thiết kế cho dự án của bạn.',
      'UI_KIT_COPY_SUCCESS': 'Đã sao chép mã nguồn thành công!',
      'UI_KIT_TAILWIND_CONFIG_TITLE': 'Cấu Hình Tailwind Mở Rộng',
      'UI_KIT_VARIANT': 'Biến Thể:'
    },
    ko: {
      // General Navigation & Switcher
      ...
      // Custom Widgets
      'WIDGET_LATTICE_TITLE': '격자 기반 키 생성기',
      'WIDGET_LATTICE_DESC': '샌드박스 환경에서 양자 내성 암호화 키 쌍을 생성합니다.',
      'WIDGET_LATTICE_BTN': '키 쌍 생성',
      'WIDGET_LATTICE_BTN_RUNNING': '격자 연산 수행 중...',
      'WIDGET_LATTICE_PUB': '격자 공개 키 (NTRU-Safe)',
      'WIDGET_LATTICE_PRIV': '격자 개인 키 (NTRU-Safe)',
      'WIDGET_LATTICE_COMPUTING': '고차원 다항식 행렬 계산 중...',
      'WIDGET_LATTICE_EXTRACTING': '최단 벡터 계수 추출 및 디코딩 중...',
      'WIDGET_API_TITLE': 'JSON-RPC API 샌드박스',
      'WIDGET_API_DESC': '실시간 검증자 API 엔드포인트를 호출하고 반환된 JSON 결과를 확인합니다.',
      'WIDGET_API_SELECT': '호출 엔드포인트 선택',
      'WIDGET_API_BTN': 'API 요청 전송',
      'WIDGET_API_PAYLOAD': '반환된 JSON 응답',
      'WIDGET_API_STATUS': '응답 상태코드',
      'WIDGET_API_EMPTY': '엔드포인트를 선택하고 요청 전송을 클릭하여 결과를 확인하세요...',
      'WIDGET_API_RUNNING': '보안 게이트웨이 접속 요청 중...',
      'WIDGET_STRESS_TITLE': '하드웨어 부하 스트레스 테스트기',
      'WIDGET_STRESS_DESC': '다양한 스레드 부하 하에서 커스텀 ASIC 가속 보드의 물리적 온도를 실시간 측정합니다.',
      'WIDGET_STRESS_BTN': '스트레스 테스트 실행',
      'WIDGET_STRESS_BTN_RUNNING': '테스트 시뮬레이션 가동 중...',
      'WIDGET_STRESS_TEMP': 'ASIC 코어 온도',
      'WIDGET_STRESS_IOPS': '실시간 연산 성능 (IOPS)',
      'WIDGET_VAL_TITLE': '탈중앙화 검증 지분 위임',
      'WIDGET_VAL_DESC': '네트워크 보안 강화를 위해 보유한 $NEURAL 지분을 활성 Validator에 위임합니다.',
      'WIDGET_VAL_SELECT': '대상 검증인 선택',
      'WIDGET_VAL_AMOUNT': '위임 Staking 수량',
      'WIDGET_VAL_BTN': '지금 지분 위임하기',
      'WIDGET_VAL_BTN_RUNNING': '블록체인 지분 거래 전송 중...',
      'WIDGET_VAL_ROSTER': '전체 검증인 목록 및 지분 현황',
      'WIDGET_VAL_COMMISSION': '수수료 비율',
      'WIDGET_VAL_TOTAL_STAKE': '총 위임 금액',
      'WIDGET_VAL_DELEGATED': '내 위임 수량',
      'WIDGET_GOV_TITLE': '탈중앙화 거버넌스 투표',
      'WIDGET_GOV_DESC': '프로토콜 업그레이드 및 예산 할당 제안서에 암호화 서명 투표를 행사합니다.',
      'WIDGET_GOV_VOTE_FOR': '찬성 투표 제출',
      'WIDGET_GOV_VOTE_AGAINST': '반대 투표 제출',
      'WIDGET_GOV_VOTED': '거버넌스 투표가 정상 반영되었습니다',
      'WIDGET_INT_TITLE': '멀티체인 Web3 SDK 연동',
      'WIDGET_INT_DESC': 'Ethereum EVM, Solana 및 Cosmos 기반 시스템에 검증 데이터 스트림을 통합합니다.',
      'WIDGET_INT_CODE': '클라이언트 연동 소스 코드 (NodeJS / JS)',
      'WIDGET_INT_COPY': '소스 코드 복사',
      'WIDGET_CLI_TITLE': '핵심 CLI 명령어 설명서',
      'WIDGET_CLI_DESC': '클라이언트 설치 및 노드 가동을 위한 주요 명령어를 즉시 복사합니다.',
      'WIDGET_CLI_COPY': '복사하기',
      'WIDGET_TUT_TITLE': '개발자 교육 튜토리얼 및 진행률',
      'WIDGET_TUT_DESC': '각 튜토리얼 단계를 체크하여 시스템 인증 자격을 취득하십시오.',
      'WIDGET_TUT_CREDENTIALS': '전체 교육 이수율',
      'WIDGET_TUT_UNLOCKED': '튜토리얼 완료 시 검증인 공식 인증서 획득 및 APY 인센티브가 활성화됩니다.',
      'WIDGET_COMPLIANCE_TITLE': '규정 준수 사항 자가 검사기',
      'WIDGET_COMPLIANCE_DESC': '노드 운용 중 패널티 발생을 최소화하기 위한 체크리스트를 점검하십시오.',
      'WIDGET_PRIVACY_TITLE': '브라우저 쿠키 및 캐시 관리자',
      'WIDGET_PRIVACY_DESC': '본 사이트는 편의를 위해 언어 및 테마 설정만 로컬 캐시에 저장하며 개인정보를 추적하지 않습니다.',
      'WIDGET_PRIVACY_CACHE': '현재 저장된 로컬 캐시 데이터:',
      'WIDGET_PRIVACY_CLEAR': '로컬 캐시 초기화',
      'WIDGET_SEC_TITLE': '보안 취약점 버그바운티 계산기',
      'WIDGET_SEC_DESC': '제보할 보안 취약점 등급에 따른 예상 버그바운티 보상 금액을 확인합니다.',
      'WIDGET_SEC_SEVERITY': '취약점 심각도 레벨',
      'WIDGET_SEC_BOUNTY': '예상 버그바운티 보상 ($NEURAL)',
      'WIDGET_SEC_SUBMIT': '보안 보고서를 security@hejidraft.com으로 직접 접수하십시오. 심각함 이상 등급은 실행 가능한 PoC 첨부가 필요합니다.',
      'WIDGET_TERMS_TITLE': '서비스 약관 동의 확인',
      'WIDGET_TERMS_DESC': '지갑 연결을 활성화하여 브라우저 식별을 표준 검증 합의 노드로 등록합니다.',
      'WIDGET_TERMS_CHECK': '모든 서비스 이용 약관 및 운용 규정에 동의합니다.',
      'WIDGET_GETTING_TITLE': 'CLI 클라이언트 설치 마법사',
      'WIDGET_GETTING_DESC': '설치 명령어로 노드 에이전트를 가동하고 메인 네트워크 연동을 시작하십시오.',
      'WIDGET_GETTING_CHECKLIST': '클라이언트 가동 체크리스트',
      'WIDGET_GETTING_STANDARD': '표준 터미널 설치 명령어',
      'WIDGET_ARCH_TITLE': '인터랙티브 시스템 아키텍처 다이어그램',
      'WIDGET_ARCH_DESC': '각 시스템 레이어에 마우스를 대면 API 명세 및 세부 합의 스키마를 확인할 수 있습니다.',
      'WIDGET_ARCH_SPECS': '해당 레이어 명세',
      'NAV_UI_KIT': '옵시디언 플럭스 UI 키트',
      'NAV_UI_DOCS': 'Base UI 문서',
      'UI_KIT_TITLE': '옵시디언 플럭스 UI 키트',
      'UI_KIT_SUBTITLE': 'Web3를 위해 설계된 고성능 글래스모피즘 및 홀로그램 컴포넌트 프리미엄 라이브러리입니다. 실시간으로 스타일을 조정하고 완성된 코드를 복사하세요.',
      'UI_KIT_THEME_TITLE': '글로벌 스타일 커스터마이저',
      'UI_KIT_PRIMARY_COLOR': '기본 강조 색상',
      'UI_KIT_PRIMARY_HUE': '기본 색조',
      'UI_KIT_PRIMARY_SAT': '기본 채도',
      'UI_KIT_PRIMARY_LIGHT': '기본 명도',
      'UI_KIT_GLASS_OPACITY': '유리 투명도',
      'UI_KIT_GLASS_BLUR': '배경 흐림',
      'UI_KIT_BORDER_STYLE': '테두리 두께',
      'UI_KIT_BORDER_NONE': '없음',
      'UI_KIT_BORDER_THIN': '얇게',
      'UI_KIT_BORDER_THICK': '두껍게',
      'UI_KIT_CATEGORIES': '컴포넌트 카테고리',
      'UI_KIT_CAT_ALL': '모든 컴포넌트',
      'UI_KIT_CAT_BUTTONS': '버튼 및 액션',
      'UI_KIT_CAT_CARDS': '글래스 카드',
      'UI_KIT_CAT_INPUTS': '콘솔 입력',
      'UI_KIT_CAT_INDICATORS': '시스템 상태 표시등',
      'UI_KIT_WORKBENCH_TITLE': '대화형 샌드박스 워크벤치',
      'WIDGET_UI_KIT_DESC': '커스터마이징된 UI 요소를 실시간으로 테스트하고, 레이아웃을 배치하고, 완성된 코드베이스 스타일 값을 내보냅니다.',
      'UI_KIT_COPY_SUCCESS': '마크업 복사 완료!',
      'UI_KIT_TAILWIND_CONFIG_TITLE': '테일윈드 구성 확장',
      'UI_KIT_VARIANT': '변형:'
    }
  };
